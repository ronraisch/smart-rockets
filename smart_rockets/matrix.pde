...
//---------------------------------------------------------------------------------------------------------------------------------------------------------  
  //set the matrix to random ints between min and max
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------  
  ...
  Matrix add(Matrix n ) {
    ...
    else{println("wrong dimention while adding matrices");}
    return newMatrix;
  }
//---------------------------------------------------------------------------------------------------------------------------------------------------------  
  //return a matrix which is this matrix - parameter matrix
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------  
  ...
  //multiply each weight by the corresponding weight
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------  
  ...
  Matrix activate() {
    ...
    for (int i =0; i<rows; i++) {
      for (int j = 0; j<cols; j++) {
        n.matrix[i][j] = activationFunction(matrix[i][j]);
      }
    }
    return n;
  }
